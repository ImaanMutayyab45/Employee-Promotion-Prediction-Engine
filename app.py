...
with tab3:
    ...
    # Show the rest of this baseline employee's profile, so it's clear the probability below
    # reflects "this specific employee, but with a different training score" — not a generic average.
    st.caption("Baseline employee used for this simulation (only Training Score is changed below):")
    ...
    st.caption(
        ...
        "(rating, awards, tenure, etc. shown above) fixed — a different baseline employee "
        "would give a different starting point."
    )
